          ...
          <div className="flex flex-col justify-center items-center mt-2 ">
            ...
            <Link href={"/book-seat/personal-info"}>
              <button className="relative z-50 cursor-pointer inline-flex h-11 mt-6 overflow-hidden rounded-md p-[1.5px] focus:outline-none gap-2">
                ...
                <span className="inline-flex font-Kanit h-full w-full cursor-pointer items-center justify-center rounded-md bg-slate-900 px-7 py-1 font-medium text-white backdrop-blur-3xl text-xs sm:text-base">
                  Start Your Journey
                </span>
              </button>
            </Link>
